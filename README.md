...
На фронте сущности представлены интерфейсами ( которые консистентны с сущностями на беке ), которые шарятся между представлениями и сервисами, все взаимодействие с беком происходит из слоя сервисов (везде использована микросервисная аритектура с внедрением зависимостей, за это отвечают фреймворки). 
